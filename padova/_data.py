...
PLACES = {
    ...
    "risorgimento": dict(nome="Museo del Risorgimento", lat=45.4078, lon=11.8769, dx=30, dy=20, card=False,
        testo="Nello stesso palazzo del Pedrocchi e sullo stesso biglietto: dalla sala egizia si passa "
              "alle bandiere, ai proclami e alle fotografie di centocinquant\u2019anni di storia, fino al 1948.",
        nota="Non costa nulla in pi\u00f9, ma costa <b>venti minuti</b>: sono gi\u00e0 conteggiati qui sopra."),
...
VARIANTE_A = dict(
    ...
    tappe=[
        ...
        ("pedrocchi",   "09:50",  "25 min",                  "4,00 €"),
        ("risorgimento","10:15",  "15 min, stesso biglietto", "Compreso"),
...
VARIANTE_B = dict(
    ...
    tappe=[
        ("stazione",    "09:30",  "20 min per il centro",    None),
        ("pedrocchi",   "09:55",  "25 min",                  "4,00 €"),
        ("risorgimento","10:22",  "18 min, stesso biglietto", "Compreso"),
        ("ragione",     "10:45",  "45 min",                  "8,00 €"),
        ("signori",     "11:35",  "15 min",                  "Gratuito"),
        ("battistero",  "11:55",  "55 min",                  "15,00 €"),
        ("pranzo",      "13:00",  "90 min",                  None),
...
VARIANTE_ADA = dict(
    ...
    tappe=[
        ...
        ("pedrocchi",   "11:45",  "25 min",                  "4,00 €"),
        ("risorgimento","12:12",  "18 min, stesso biglietto", "Compreso"),
        ("signori",     "12:35",  "20 min",                  "Gratuito"),
        ("pranzo",      "13:00",  "90 min",                  None),
...
# ----------------------------------------------------------------- quali righe di tabella
# descrivono ciascuna tappa, e in quale ordine mostrarle
RIGHE_TAPPA = {
    "stazione":     [],
    "pedrocchi":    [u"Caff\u00e8 Pedrocchi \u2014 Piano Nobile"],
    "risorgimento": [u"Museo del Risorgimento e dell\u2019et\u00e0 contemporanea"],
    "bo":           [u"Palazzo del Bo"],
    "ragione":      [u"Palazzo della Ragione"],
    "signori":      [u"Piazza dei Signori e Torre dell\u2019Orologio"],
    "pranzo":       [u"Bacaro Padovano"],
    "battistero":   [u"Battistero della Cattedrale", u"Duomo di Padova"],
    "santo":        [u"Basilica del Santo", u"Oratorio di San Giorgio"],
    "orto":         [u"Orto Botanico"],
    "prato":        [u"Prato della Valle"],
}
...
CARD_PREZZO = u"28,00 €"
CARD_SITI = [
    dict(nome="Cappella degli Scrovegni", wiki=u"https://it.wikipedia.org/wiki/Cappella_degli_Scrovegni", fonte=(u"Musei Civici di Padova", u"https://padovamusei.it/it/biglietti-orari-musei"), lat=45.4118, lon=11.8795, dx=22, dy=-14,
         ...
         escluso=True),
    dict(nome="Battistero della Cattedrale", wiki=u"https://it.wikipedia.org/wiki/Battistero_di_Padova", fonte=(u"Kalatà / Museo Diocesano", u"https://kalata.it/esperienza/battistero-padova/"), lat=45.4064, lon=11.8707, tappa="battistero",
    ...
    dict(nome="Palazzo della Ragione", wiki=u"https://it.wikipedia.org/wiki/Palazzo_della_Ragione_(Padova)", fonte=(u"Musei Civici di Padova", u"https://padovamusei.it/it/biglietti-orari-musei"), lat=45.4074, lon=11.8747, tappa="ragione",
    ...
    dict(nome="Oratorio di San Giorgio", wiki=u"https://it.wikipedia.org/wiki/Oratorio_di_San_Giorgio_(Padova)", fonte=(u"Basilica del Santo", u"https://www.santantonio.org/it/content/orario-e-biglietto-unico-i-siti-museali-del-complesso-antoniano"), lat=45.4012, lon=11.8802, dx=-30, dy=22, tappa="santo",
    ...
    dict(nome="Basilica del Santo", wiki=u"https://it.wikipedia.org/wiki/Basilica_di_Sant%27Antonio_di_Padova", fonte=(u"Basilica del Santo", u"https://www.santantonio.org/it/basilica/orari"), lat=45.4014, lon=11.8809, tappa="santo",
    ...
    dict(nome="Chiesa degli Eremitani", wiki=u"https://it.wikipedia.org/wiki/Chiesa_degli_Eremitani", fonte=None, lat=45.4110, lon=11.8786, dx=-32, dy=20,
         ...
         prezzo="Gratuito"),
    dict(nome="Oratorio di San Michele", wiki=u"https://it.wikipedia.org/wiki/Oratorio_di_San_Michele_(Padova)", fonte=(u"Musei Civici di Padova", u"https://padovamusei.it/it/biglietti-orari-musei"), lat=45.4059, lon=11.8695,
    ...
    dict(nome="Cappella della Reggia Carrarese", wiki=u"https://it.wikipedia.org/wiki/Reggia_Carrarese", fonte=(u"turismopadova.it", u"https://www.turismopadova.it/accoglienza-in-citta/urbspictacard/"), lat=45.4085, lon=11.8732,
...
ALTRI_LUOGHI = [
    dict(nome="Museo del Risorgimento e dell\u2019et\u00e0 contemporanea",
         fonte=(u"Comune di Padova", u"https://padovacultura.padovanet.it/it/musei/museo-del-risorgimento"),
         wiki=u"https://it.wikipedia.org/wiki/Museo_del_Risorgimento_e_dell%27et%C3%A0_contemporanea",
         lat=45.4078, lon=11.8769, dx=30, dy=20, tappa="risorgimento",
         perche="Un secolo e mezzo di storia padovana e nazionale, dalla caduta della Repubblica Veneta alla "
                "Costituzione del 1948. Sta <b>accanto al Piano Nobile</b>, nello stesso Stabilimento Pedrocchi "
                "e sullo <b>stesso biglietto</b>: si passa da una sala all\u2019altra.",
         orari="09:30\u201312:30 e 15:30\u201318:00<em>chiuso il luned\u00ec non festivo \u2014 il sabato \u00e8 aperto</em>",
         prezzo="Compreso<em>nei 4,00 \u20ac del biglietto del Piano Nobile</em>"),
    dict(nome="Brutal", wiki=None, fonte=(u"OpenStreetMap", u"https://www.openstreetmap.org/?mlat=45.40742&mlon=11.87398#map=19/45.40742/11.87398"),
    ...
    dict(nome="All’Ombra della Piazza", wiki=None, fonte=(u"OpenStreetMap", u"https://www.openstreetmap.org/?mlat=45.40816&mlon=11.87504#map=19/45.40816/11.87504"),
    ...
    dict(nome="Bacaro Padovano", wiki=None, fonte=(u"bacaropadovano.com", u"https://www.bacaropadovano.com/contatti/"), lat=45.40545, lon=11.87242, tipo="pasto", tappa="pranzo",
    ...
    dict(nome="Palazzo del Bo", wiki=u"https://it.wikipedia.org/wiki/Palazzo_del_Bo", fonte=(u"Università di Padova", u"https://www.unipd.it/palazzo-bo-900-gio-ponti-informazioni-tariffe"), lat=45.4069, lon=11.8772, tappa="bo",
    ...
    dict(nome="Caffè Pedrocchi — Piano Nobile", wiki=u"https://it.wikipedia.org/wiki/Caff%C3%A8_Pedrocchi", fonte=(u"Comune di Padova", u"https://padovaper.comune.padova.it/servizi/cultura-e-turismo/piano-nobile-dello-stabilimento-pedrocchi"), lat=45.4077, lon=11.8766, tappa="pedrocchi",
    ...
    dict(nome="Orto Botanico", wiki=u"https://it.wikipedia.org/wiki/Orto_botanico_di_Padova", fonte=(u"ortobotanico1545.it", u"https://ortobotanico1545.it/visita/orari/"), lat=45.3994, lon=11.8802, tappa="orto",
    ...
    dict(nome="Prato della Valle", wiki=u"https://it.wikipedia.org/wiki/Prato_della_Valle", fonte=None, lat=45.3986, lon=11.8770, tappa="prato",
         ...
         prezzo="Gratuito"),
    dict(nome="Piazza dei Signori e Torre dell’Orologio", wiki=u"https://it.wikipedia.org/wiki/Piazza_dei_Signori_(Padova)", fonte=None, lat=45.4079, lon=11.8720, tappa="signori",
    ...
    dict(nome="Duomo di Padova", wiki=u"https://it.wikipedia.org/wiki/Duomo_di_Padova", fonte=None, lat=45.4065, lon=11.8711, tappa="battistero",
         ...
         prezzo="Gratuito"),
    dict(nome="Basilica di Santa Giustina", wiki=u"https://it.wikipedia.org/wiki/Abbazia_di_Santa_Giustina", fonte=None, lat=45.3983, lon=11.8798,
         ...
         prezzo="Gratuito"),
    dict(nome="Musei Civici agli Eremitani", wiki=u"https://it.wikipedia.org/wiki/Musei_civici_di_Padova", fonte=(u"Musei Civici di Padova", u"https://padovamusei.it/it/biglietti-orari-musei"), lat=45.4114, lon=11.8797, dx=-24, dy=16,
    ...
    dict(nome="Palazzo Zuckermann", wiki=u"https://it.wikipedia.org/wiki/Palazzo_Zuckermann", fonte=(u"Musei Civici di Padova", u"https://padovamusei.it/it/biglietti-orari-musei"), lat=45.4121, lon=11.8789,
    ...
    dict(nome="Loggia e Odeo Cornaro", wiki=u"https://it.wikipedia.org/wiki/Loggia_e_Odeo_Cornaro", fonte=(u"Musei Civici di Padova", u"https://padovamusei.it/it/biglietti-orari-musei"), lat=45.4037, lon=11.8827,
    ...
    dict(nome="MUSME — Museo di Storia della Medicina", wiki=u"https://it.wikipedia.org/wiki/MUSME", fonte=(u"musme.it", u"https://www.musme.it/pianifica-la-visita/"), lat=45.4042, lon=11.8797,
